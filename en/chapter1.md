...
Both this online textbook and the *Lean* theorem prover are new and ongoing projects. You can learn more about Lean from its [project page](http://leanprover.github.io/), the Leann [community pages](http://leanprover-community.github.io/), and the online textbook, [Theorem Proving in Lean](http://leanprover.github.io/theorem_proving_in_lean/).
